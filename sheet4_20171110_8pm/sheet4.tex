...
{\color{incolor}In [{\color{incolor}120}]:} \PY{k+kn}{import} \PY{n+nn}{numpy}\PY{o}{,}\PY{n+nn}{utils}
\end{Verbatim}
...
\begin{figure}
\centering
%\includegraphics{softplus.png}
\caption{plot generated using fooplot.com}
\end{figure}
...
tends to the identity for very positive input values.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}121}]:} \PY{k}{def} \PY{n+nf}{softplus}\PY{p}{(}\PY{n}{z}\PY{p}{)}\PY{p}{:} \PY{k}{return} \PY{n}{numpy}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{numpy}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{z}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
manner.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}122}]:} \PY{n}{X} \PY{o}{=} \PY{n}{utils}\PY{o}{.}\PY{n}{softplus\PYZus{}inputs}
...
prints for all cases the input and the corresponding function output:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}123}]:} \PY{n}{Y} \PY{o}{=} \PY{n}{softplus}\PY{p}{(}\PY{n}{X}\PY{p}{)}
          \PY{k}{for} \PY{n}{x}\PY{p}{,}\PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{)}\PY{p}{:}
              \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{softplus(}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{) = }\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
softplus( 10000.0000) =         inf
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
C:\textbackslash{}Program Files\textbackslash{}Anaconda2\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}ipykernel\_launcher.py:1: RuntimeWarning: overflow encountered in exp
...
time, to see whether the problem comes from numpy arrays:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}124}]:} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{X}\PY{p}{:}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}125}]:} \PY{k}{def} \PY{n+nf}{softplus\PYZus{}opt}\PY{p}{(}\PY{n}{Z}\PY{p}{)}\PY{p}{:}
              \PY{n}{result} \PY{o}{=} \PY{p}{[}\PY{p}{]}
              \PY{k}{for} \PY{n}{z} \PY{o+ow}{in} \PY{n}{Z}\PY{p}{:}
                  \PY{k}{if} \PY{n}{z} \PY{o}{\PYZgt{}} \PY{l+m+mi}{100}\PY{p}{:}
                      \PY{n}{result} \PY{o}{+}\PY{o}{=} \PY{p}{[}\PY{n}{z}\PY{p}{]}
                  \PY{k}{else}\PY{p}{:}
                      \PY{n}{result} \PY{o}{+}\PY{o}{=} \PY{p}{[}\PY{n}{numpy}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{numpy}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{z}\PY{p}{)}\PY{p}{)}\PY{p}{]}
              \PY{k}{return} \PY{n}{result}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}126}]:} \PY{n}{Y} \PY{o}{=} \PY{n}{softplus\PYZus{}opt}\PY{p}{(}\PY{n}{X}\PY{p}{)}
          \PY{k}{for} \PY{n}{x}\PY{p}{,}\PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{)}\PY{p}{:}
              \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{softplus(}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{) = }\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}127}]:} \PY{c+c1}{\PYZsh{} using clip to give the boundary of input vector. }
          \PY{c+c1}{\PYZsh{} Ref in lecture4 \PYZdq{}The sigmoid function (4)\PYZdq{}}
          
          \PY{k}{def} \PY{n+nf}{softplus\PYZus{}npopt}\PY{p}{(}\PY{n}{Z}\PY{p}{)}\PY{p}{:}
              \PY{n}{clipZ} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{clip}\PY{p}{(}\PY{n}{Z}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{l+m+mi}{10000}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{)}
              \PY{n}{Y} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{numpy}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{clipZ}\PY{p}{)}\PY{p}{)}
              \PY{n}{results} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{clipZ} \PY{o}{==} \PY{l+m+mi}{100}\PY{p}{,} \PY{n}{Z}\PY{p}{,} \PY{n}{Y}\PY{p}{)}
              \PY{k}{return} \PY{n}{results}
              
          \PY{n}{Y} \PY{o}{=} \PY{n}{softplus\PYZus{}npopt}\PY{p}{(}\PY{n}{X}\PY{p}{)}
          
          \PY{k}{for} \PY{n}{x}\PY{p}{,}\PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{)}\PY{p}{:}
              \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{softplus3(}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{) = }\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
thus problematic), and can be found in the file \texttt{utils.py}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}128}]:} \PY{k+kn}{import} \PY{n+nn}{numpy}\PY{o}{,}\PY{n+nn}{utils}
          ...
          \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{k}{getlogZ}(utils.w\PYZus{}small))
          \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{k}{getlogZ}(utils.w\PYZus{}medium))
          \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{k}{getlogZ}(utils.w\PYZus{}big))
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}129}]:} \PY{k}{def} \PY{n+nf}{getlogZ\PYZus{}opt}\PY{p}{(}\PY{n}{w}\PY{p}{)}\PY{p}{:}
              
              \PY{c+c1}{\PYZsh{} use the log\PYZhy{}sum\PYZhy{}exp trick. for the proof see }
              \PY{c+c1}{\PYZsh{} https://www.xarg.org/2016/06/the\PYZhy{}log\PYZhy{}sum\PYZhy{}exp\PYZhy{}trick\PYZhy{}in\PYZhy{}machine\PYZhy{}learning/    }
              
              \PY{n}{argForExp\PYZus{}i1} \PY{o}{=} \PY{p}{[}\PY{p}{]}
              
              \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{itertools}\PY{o}{.}\PY{n}{product}\PY{p}{(}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{repeat}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
                  \PY{n}{argForExp} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{w}\PY{p}{)}
                  \PY{n}{argForExp\PYZus{}i1}\PY{o}{.}\PY{n}{append}\PY{p}{(} \PY{n}{argForExp} \PY{p}{)}
              
              \PY{n}{offsetForExpArgs} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(} \PY{n}{argForExp\PYZus{}i1} \PY{p}{)}
               
              \PY{n}{Zrest} \PY{o}{=} \PY{l+m+mf}{0.}
              \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{itertools}\PY{o}{.}\PY{n}{product}\PY{p}{(}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{repeat}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
                  \PY{n}{Zrest} \PY{o}{+}\PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{exp} \PY{p}{(} \PY{n}{numpy}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{w}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{n}{offsetForExpArgs} \PY{p}{)}
              
              \PY{n}{lnZ} \PY{o}{=} \PY{n}{offsetForExpArgs} \PY{o}{+} \PY{n}{numpy}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{Zrest}\PY{p}{)}
              
              \PY{k}{return} \PY{n}{lnZ}
          
          \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{k}{getlogZ\PYZus{}opt}(utils.w\PYZus{}small))
          \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{k}{getlogZ\PYZus{}opt}(utils.w\PYZus{}medium))
          \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}11.4f}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{k}{getlogZ\PYZus{}opt}(utils.w\PYZus{}big))
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}130}]:} \PY{n}{lnZ\PYZus{}wBig} \PY{o}{=} \PY{n}{getlogZ\PYZus{}opt}\PY{p}{(} \PY{n}{utils}\PY{o}{.}\PY{n}{w\PYZus{}big} \PY{p}{)}
              
          \PY{k}{def} \PY{n+nf}{logP}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
              \PY{n}{logP} \PY{o}{=} \PY{o}{\PYZhy{}} \PY{n}{lnZ\PYZus{}wBig} \PY{o}{+} \PY{n}{numpy}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{w\PYZus{}big}\PY{p}{)} 
              \PY{k}{return} \PY{n}{logP}
          
          \PY{k}{def} \PY{n+nf}{getIndicesOfProbsLargerOrEqualThan}\PY{p}{(} \PY{n}{probLowerBound} \PY{p}{)}\PY{p}{:}        
              \PY{n}{iBinVec} \PY{o}{=} \PY{l+m+mi}{0}
              \PY{n}{iLargerOrEqual} \PY{o}{=} \PY{p}{[}\PY{p}{]}
              \PY{k}{for} \PY{n}{binVec} \PY{o+ow}{in} \PY{n}{itertools}\PY{o}{.}\PY{n}{product}\PY{p}{(}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{repeat}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
                  \PY{n}{logPBinVec} \PY{o}{=} \PY{n}{logP}\PY{p}{(}\PY{n}{binVec}\PY{p}{)}
                  \PY{n}{pBinVec} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{exp}\PY{p}{(} \PY{n}{logPBinVec} \PY{p}{)}
                  \PY{k}{if}\PY{p}{(} \PY{n}{pBinVec} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{probLowerBound} \PY{p}{)}\PY{p}{:}
                      \PY{n}{iLargerOrEqual}\PY{o}{.}\PY{n}{append}\PY{p}{(} \PY{n}{iBinVec} \PY{p}{)}
                  \PY{n}{iBinVec} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
          
              \PY{k}{return} \PY{n}{iLargerOrEqual}
          
          \PY{k}{print}\PY{p}{(} \PY{n}{getIndicesOfProbsLargerOrEqualThan}\PY{p}{(} \PY{l+m+mf}{1e\PYZhy{}3} \PY{p}{)} \PY{p}{)}
\end{Verbatim}
...
The function below implements such function:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}131}]:} \PY{k+kn}{import} \PY{n+nn}{numpy}\PY{o}{,}\PY{n+nn}{numpy.linalg}\PY{o}{,}\PY{n+nn}{utils}
...
in the file \texttt{utils.py} gives the following probabilities:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}132}]:} \PY{k}{print}\PY{p}{(}\PY{n}{logp}\PY{p}{(}\PY{n}{utils}\PY{o}{.}\PY{n}{X1}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{m1}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{S1}\PY{p}{)}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{n}{logp}\PY{p}{(}\PY{n}{utils}\PY{o}{.}\PY{n}{X2}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{m2}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{S2}\PY{p}{)}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{n}{logp}\PY{p}{(}\PY{n}{utils}\PY{o}{.}\PY{n}{X3}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{m3}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{S3}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
C:\textbackslash{}Program Files\textbackslash{}Anaconda2\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}ipykernel\_launcher.py:24: RuntimeWarning: divide by zero encountered in log
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}134}]:} \PY{c+c1}{\PYZsh{}This function is numerically instable for multiple reasons. }
          \PY{c+c1}{\PYZsh{} 1 The product of many probabilities, }
          \PY{c+c1}{\PYZsh{} 2 the inversion of a large covariance matrix, }
          \PY{c+c1}{\PYZsh{} 3 and the computation of its determinant, }
          \PY{c+c1}{\PYZsh{} are all potential causes for overflow. }
          
          \PY{k}{def} \PY{n+nf}{logp\PYZus{}opt}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{m}\PY{p}{,}\PY{n}{S}\PY{p}{)}\PY{p}{:}
              
              \PY{c+c1}{\PYZsh{} Find the number of dimensions from the data vector}
              \PY{n}{d} \PY{o}{=} \PY{n}{X}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
              
              \PY{c+c1}{\PYZsh{} prob2 = inverting large matrix. }
              \PY{n}{L} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{cholesky}\PY{p}{(}\PY{n}{S}\PY{p}{)}
              \PY{n}{LT} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{transpose}\PY{p}{(} \PY{n}{L} \PY{p}{)}
              \PY{n}{L\PYZus{}inv} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{L}\PY{p}{)}
              \PY{n}{LT\PYZus{}inv} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{inv}\PY{p}{(}\PY{n}{LT}\PY{p}{)}
              \PY{c+c1}{\PYZsh{} prob3 = computation of det.    }
              \PY{n}{detS} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{det}\PY{p}{(} \PY{n}{L} \PY{p}{)} \PY{o}{*} \PY{n}{numpy}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{det}\PY{p}{(} \PY{n}{LT} \PY{p}{)}
              
              \PY{c+c1}{\PYZsh{} Compute the quadratic terms for all data points}
              \PY{n}{vecDev} \PY{o}{=} \PY{n}{X}\PY{o}{\PYZhy{}}\PY{n}{m}
              \PY{n}{vecDevMapped1} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{dot}\PY{p}{(} \PY{n}{vecDev} \PY{p}{,} \PY{n}{LT\PYZus{}inv} \PY{p}{)}
              \PY{n}{vecDevMapped2} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{dot}\PY{p}{(} \PY{n}{vecDevMapped1} \PY{p}{,} \PY{n}{L\PYZus{}inv} \PY{p}{)}
              \PY{n}{prodComponents\PYZus{}i1} \PY{o}{=} \PY{n}{vecDevMapped2} \PY{o}{*} \PY{n}{vecDev}
              \PY{n}{scalProd} \PY{o}{=} \PY{n}{prodComponents\PYZus{}i1}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
              \PY{n}{Q} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5}\PY{o}{*}\PY{n}{scalProd}
              
              \PY{c+c1}{\PYZsh{} Raise them quadratic terms to the exponential}
              \PY{n}{Q} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{Q}\PY{p}{)}
          
              \PY{c+c1}{\PYZsh{} Divide by the terms in the denominator}
              \PY{n}{P} \PY{o}{=} \PY{n}{Q} \PY{o}{/} \PY{n}{numpy}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{numpy}\PY{o}{.}\PY{n}{pi}\PY{p}{)}\PY{o}{*}\PY{o}{*}\PY{n}{d} \PY{o}{*} \PY{n}{detS} \PY{p}{)}
              
              \PY{c+c1}{\PYZsh{} prob1 \PYZhy{}\PYZgt{} solution = replace prod by sum.}
              \PY{c+c1}{\PYZsh{} Take the product of the probability of each data points}
              \PY{n}{lnP} \PY{o}{=} \PY{n}{numpy}\PY{o}{.}\PY{n}{sum}\PY{p}{(} \PY{n}{numpy}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{P}\PY{p}{)} \PY{p}{)}
              
              \PY{c+c1}{\PYZsh{} Return the log\PYZhy{}probability}
              \PY{k}{return} \PY{n}{lnP}
          
          \PY{k}{print}\PY{p}{(}\PY{n}{logp\PYZus{}opt}\PY{p}{(}\PY{n}{utils}\PY{o}{.}\PY{n}{X1}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{m1}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{S1}\PY{p}{)}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{n}{logp\PYZus{}opt}\PY{p}{(}\PY{n}{utils}\PY{o}{.}\PY{n}{X2}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{m2}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{S2}\PY{p}{)}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{n}{logp\PYZus{}opt}\PY{p}{(}\PY{n}{utils}\PY{o}{.}\PY{n}{X3}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{m3}\PY{p}{,}\PY{n}{utils}\PY{o}{.}\PY{n}{S3}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
-inf
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
C:\textbackslash{}Program Files\textbackslash{}Anaconda2\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}ipykernel\_launcher.py:36: RuntimeWarning: divide by zero encountered in log
